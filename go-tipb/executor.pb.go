...
type TiFlashScanContext struct {
	TotalScannedPacksInDmfile      *uint64 `protobuf:"varint,1,opt,name=total_scanned_packs_in_dmfile,json=totalScannedPacksInDmfile" json:"total_scanned_packs_in_dmfile,omitempty"`
	TotalSkippedPacksInDmfile      *uint64 `protobuf:"varint,2,opt,name=total_skipped_packs_in_dmfile,json=totalSkippedPacksInDmfile" json:"total_skipped_packs_in_dmfile,omitempty"`
	TotalScannedRowsInDmfile       *uint64 `protobuf:"varint,3,opt,name=total_scanned_rows_in_dmfile,json=totalScannedRowsInDmfile" json:"total_scanned_rows_in_dmfile,omitempty"`
	TotalSkippedRowsInDmfile       *uint64 `protobuf:"varint,4,opt,name=total_skipped_rows_in_dmfile,json=totalSkippedRowsInDmfile" json:"total_skipped_rows_in_dmfile,omitempty"`
	TotalRoughSetIndexLoadTimeInNs *uint64 `protobuf:"varint,5,opt,name=total_rough_set_index_load_time_in_ns,json=totalRoughSetIndexLoadTimeInNs" json:"total_rough_set_index_load_time_in_ns,omitempty"`
	TotalDmfileReadTimeInNs        *uint64 `protobuf:"varint,6,opt,name=total_dmfile_read_time_in_ns,json=totalDmfileReadTimeInNs" json:"total_dmfile_read_time_in_ns,omitempty"`
	TotalCreateSnapshotTimeInNs    *uint64 `protobuf:"varint,7,opt,name=total_create_snapshot_time_in_ns,json=totalCreateSnapshotTimeInNs" json:"total_create_snapshot_time_in_ns,omitempty"`
	XXX_unrecognized               []byte  `json:"-"`
}
...
func (m *TiFlashScanContext) GetTotalScannedPacksInDmfile() uint64 {
	if m != nil && m.TotalScannedPacksInDmfile != nil {
		return *m.TotalScannedPacksInDmfile
	}
	return 0
}

func (m *TiFlashScanContext) GetTotalSkippedPacksInDmfile() uint64 {
	if m != nil && m.TotalSkippedPacksInDmfile != nil {
		return *m.TotalSkippedPacksInDmfile
	}
	return 0
}

func (m *TiFlashScanContext) GetTotalScannedRowsInDmfile() uint64 {
	if m != nil && m.TotalScannedRowsInDmfile != nil {
		return *m.TotalScannedRowsInDmfile
	}
	return 0
}

func (m *TiFlashScanContext) GetTotalSkippedRowsInDmfile() uint64 {
	if m != nil && m.TotalSkippedRowsInDmfile != nil {
		return *m.TotalSkippedRowsInDmfile
	}
	return 0
}

func (m *TiFlashScanContext) GetTotalRoughSetIndexLoadTimeInNs() uint64 {
	if m != nil && m.TotalRoughSetIndexLoadTimeInNs != nil {
		return *m.TotalRoughSetIndexLoadTimeInNs
	}
	return 0
}

func (m *TiFlashScanContext) GetTotalDmfileReadTimeInNs() uint64 {
	if m != nil && m.TotalDmfileReadTimeInNs != nil {
		return *m.TotalDmfileReadTimeInNs
	}
	return 0
}

func (m *TiFlashScanContext) GetTotalCreateSnapshotTimeInNs() uint64 {
	if m != nil && m.TotalCreateSnapshotTimeInNs != nil {
		return *m.TotalCreateSnapshotTimeInNs
	}
	return 0
}
...
func (m *TiFlashScanContext) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TotalScannedPacksInDmfile != nil {
		dAtA[i] = 0x8
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.TotalScannedPacksInDmfile))
	}
	if m.TotalSkippedPacksInDmfile != nil {
		dAtA[i] = 0x10
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.TotalSkippedPacksInDmfile))
	}
	if m.TotalScannedRowsInDmfile != nil {
		dAtA[i] = 0x18
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.TotalScannedRowsInDmfile))
	}
	if m.TotalSkippedRowsInDmfile != nil {
		dAtA[i] = 0x20
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.TotalSkippedRowsInDmfile))
	}
	if m.TotalRoughSetIndexLoadTimeInNs != nil {
		dAtA[i] = 0x28
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.TotalRoughSetIndexLoadTimeInNs))
	}
	if m.TotalDmfileReadTimeInNs != nil {
		dAtA[i] = 0x30
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.TotalDmfileReadTimeInNs))
	}
	if m.TotalCreateSnapshotTimeInNs != nil {
		dAtA[i] = 0x38
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(*m.TotalCreateSnapshotTimeInNs))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *TiFlashScanContext) Size() (n int) {
	...
	_ = l
	if m.TotalScannedPacksInDmfile != nil {
		n += 1 + sovExecutor(uint64(*m.TotalScannedPacksInDmfile))
	}
	if m.TotalSkippedPacksInDmfile != nil {
		n += 1 + sovExecutor(uint64(*m.TotalSkippedPacksInDmfile))
	}
	if m.TotalScannedRowsInDmfile != nil {
		n += 1 + sovExecutor(uint64(*m.TotalScannedRowsInDmfile))
	}
	if m.TotalSkippedRowsInDmfile != nil {
		n += 1 + sovExecutor(uint64(*m.TotalSkippedRowsInDmfile))
	}
	if m.TotalRoughSetIndexLoadTimeInNs != nil {
		n += 1 + sovExecutor(uint64(*m.TotalRoughSetIndexLoadTimeInNs))
	}
	if m.TotalDmfileReadTimeInNs != nil {
		n += 1 + sovExecutor(uint64(*m.TotalDmfileReadTimeInNs))
	}
	if m.TotalCreateSnapshotTimeInNs != nil {
		n += 1 + sovExecutor(uint64(*m.TotalCreateSnapshotTimeInNs))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *TiFlashScanContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalScannedPacksInDmfile", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalScannedPacksInDmfile = &v
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalSkippedPacksInDmfile", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalSkippedPacksInDmfile = &v
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalScannedRowsInDmfile", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalScannedRowsInDmfile = &v
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalSkippedRowsInDmfile", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalSkippedRowsInDmfile = &v
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalRoughSetIndexLoadTimeInNs", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalRoughSetIndexLoadTimeInNs = &v
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalDmfileReadTimeInNs", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalDmfileReadTimeInNs = &v
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalCreateSnapshotTimeInNs", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalCreateSnapshotTimeInNs = &v
		default:
			iNdEx = preIndex
			skippy, err := skipExecutor(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorExecutor = []byte{
	...
	,
}
