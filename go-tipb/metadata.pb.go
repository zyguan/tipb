...
type IsTrueOrFalseMetadata struct {
	KeepNull         bool   `protobuf:"varint,1,req,name=keep_null,json=keepNull" json:"keep_null"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *IsTrueOrFalseMetadata) Reset()                    { *m = IsTrueOrFalseMetadata{} }
func (m *IsTrueOrFalseMetadata) String() string            { return proto.CompactTextString(m) }
func (*IsTrueOrFalseMetadata) ProtoMessage()               {}
func (*IsTrueOrFalseMetadata) Descriptor() ([]byte, []int) { return fileDescriptorMetadata, []int{2} }

func (m *IsTrueOrFalseMetadata) GetKeepNull() bool {
	if m != nil {
		return m.KeepNull
	}
	return false
...
func init() {
	...
	proto.RegisterType((*IsTrueOrFalseMetadata)(nil), "tipb.IsTrueOrFalseMetadata")
}
...
func (m *IsTrueOrFalseMetadata) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *IsTrueOrFalseMetadata) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *IsTrueOrFalseMetadata) Size() (n int) {
	var l int
	_ = l
	n += 2
	if m.XXX_unrecognized != nil {
...
func (m *IsTrueOrFalseMetadata) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IsTrueOrFalseMetadata: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IsTrueOrFalseMetadata: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorMetadata = []byte{
	...
	0x30, 0x29, 0x30, 0x6a, 0xf0, 0x04, 0x41, 0x79, 0x4a, 0x56, 0x5c, 0xa2, 0x9e, 0xc5, 0x21, 0x45,
	0xa5, 0xa9, 0xfe, 0x45, 0x6e, 0x89, 0x39, 0xc5, 0xa9, 0x70, 0x13, 0x15, 0xb9, 0x38, 0xb3, 0x53,
	0x53, 0x0b, 0x30, 0x8d, 0xe4, 0x00, 0x09, 0x83, 0xcc, 0x74, 0xd2, 0x3c, 0xf1, 0x48, 0x8e, 0xf1,
	0xc2, 0x23, 0x39, 0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x67, 0x3c, 0x96, 0x63, 0xe0, 0x12, 0x4d, 0xce,
	0xcf, 0xd5, 0x2b, 0xc8, 0xcc, 0x4b, 0x4f, 0x4e, 0x2c, 0xd0, 0x2b, 0xc9, 0x4c, 0x49, 0xd2, 0x03,
	0x79, 0x3e, 0x80, 0x11, 0x10, 0x00, 0x00, 0xff, 0xff, 0x10, 0x58, 0xd2, 0xe2, 0x15, 0x01, 0x00,
	0x00,
}
