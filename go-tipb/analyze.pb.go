...
func (m *AnalyzeIndexResp) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Collector != nil {
		...
		n6, err := m.Collector.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *SampleCollector) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FmSketch != nil {
		...
		n7, err := m.FmSketch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
	...
	if m.CmSketch != nil {
		...
		n8, err := m.CmSketch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
var fileDescriptorAnalyze = []byte{
	...
	,
}
